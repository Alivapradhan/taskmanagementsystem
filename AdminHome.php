      ...
      <div class="header">
        <div class="header-left">
         ...
         <select  id="projects" name="projects" onchange="search_by_project()" >
          <option>Weather management system</option>
          <option>Todo list</option>
          <option>Movie app</option>
          <option>Maze game</option>
          <option>Countdown Timer</option>
          <option>Quotes Generator.</option>
          <option>Speech Detection.</option>
          <option>ATM managenent system</option>
          <option>Digital clock</option>
          <option>BMI calculater</option>
          <option>Quiz app</option>
          <option>Amazon clone page</option>
          <option>Music player app</option>
          <?php
